...
const char HTTP_END[] PROGMEM =
  "<div style='text-align:right;font-size:11px;'><hr/><a href='https://v253.pl' target='_blank' style='color:#aaa;'>Tasmota %s " D_BY " Theo Arends, modyfikacja R-SOFT Mateusz Ryndak 1.0.9</a></div>"
  "</div>"
  "</body>"
  "</html>";
